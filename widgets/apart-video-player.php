...
/**
 * Elementor Apart Video Player widget.
 *
 * Elementor widget that displays a video player for Aparat and self-hosted videos.
 *
 * @since 1.0.0
 */
class Apart_Elementor_Video_Player_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Apart Video Player', 'apart-elementor-video-player' );
	}
	...
	public function get_keywords() {
		return [ 'video', 'player', 'aparat', 'apart', 'embed', 'self-hosted' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_video',
			[
				'label' => esc_html__( 'Video', 'apart-elementor-video-player' ),
			]
		);
		...
		$this->add_control(
			'video_type',
			[
				'label' => esc_html__( 'Source', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'aparat',
				'options' => [
					'aparat' => esc_html__( 'Aparat', 'apart-elementor-video-player' ),
					'hosted' => esc_html__( 'Self Hosted', 'apart-elementor-video-player' ),
				],
		...
		$this->add_control(
			'aparat_url',
			[
				'label' => esc_html__( 'Aparat Video URL', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your Aparat URL', 'apart-elementor-video-player' ) . ' (e.g., https://www.aparat.com/v/ror49jn)',
				'label_block' => true,
				'condition' => [
					'video_type' => 'aparat',
				],
		...
		$this->add_control(
			'insert_url',
			[
				'label' => esc_html__( 'External URL', 'apart-elementor-video-player' ),
		...
		$this->add_control(
			'hosted_url',
			[
				'label' => esc_html__( 'Choose Video File', 'apart-elementor-video-player' ),
		...
		$this->add_control(
			'external_url',
			[
				'label' => esc_html__( 'URL', 'apart-elementor-video-player' ),
				...
				'placeholder' => esc_html__( 'Enter your URL', 'apart-elementor-video-player' ),
				'condition' => [
					'video_type' => 'hosted',
					'insert_url' => 'yes',
				],
		...
		$this->add_control(
			'start',
			[
				'label' => esc_html__( 'Start Time', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Specify a start time (in seconds)', 'apart-elementor-video-player' ),
				'frontend_available' => true,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'end',
			[
				'label' => esc_html__( 'End Time', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Specify an end time (in seconds)', 'apart-elementor-video-player' ),
				'condition' => [
					'video_type' => 'hosted',
				],
				'frontend_available' => true,
		...
		$this->add_control(
			'video_options',
			[
				'label' => esc_html__( 'Video Options', 'apart-elementor-video-player' ),
		...
		$this->add_control(
			'autoplay',
			[
				'label' => esc_html__( 'Autoplay', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'play_on_mobile',
			[
				'label' => esc_html__( 'Play On Mobile', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'autoplay' => 'yes',
				],
		...
		$this->add_control(
			'mute',
			[
				'label' => esc_html__( 'Mute', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'loop',
			[
				'label' => esc_html__( 'Loop', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'controls',
			[
				'label' => esc_html__( 'Player Controls', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'apart-elementor-video-player' ),
				'label_on' => esc_html__( 'Show', 'apart-elementor-video-player' ),
				'default' => 'yes',
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'download_button',
			[
				'label' => esc_html__( 'Download Button', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'apart-elementor-video-player' ),
				'label_on' => esc_html__( 'Show', 'apart-elementor-video-player' ),
				'condition' => [
		...
		$this->add_control(
			'preload',
			[
				'label' => esc_html__( 'Preload', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'metadata' => esc_html__( 'Metadata', 'apart-elementor-video-player' ),
					'auto' => esc_html__( 'Auto', 'apart-elementor-video-player' ),
					'none' => esc_html__( 'None', 'apart-elementor-video-player' ),
				],
				'default' => 'metadata',
				'condition' => [
					'video_type' => 'hosted',
		...
		$this->add_control(
			'poster',
			[
				'label' => esc_html__( 'Poster', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Overlay', 'apart-elementor-video-player' ),
			]
		);
		...
		$this->add_control(
			'image_overlay',
			[
				'label' => esc_html__( 'Choose Image', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
		...
		$this->add_control(
			'show_play_icon',
			[
				'label' => esc_html__( 'Play Icon', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_off' => esc_html__( 'Hide', 'apart-elementor-video-player' ),
				'label_on' => esc_html__( 'Show', 'apart-elementor-video-player' ),
		...
		$this->add_control(
			'play_icon',
			[
				'label' => esc_html__( 'Icon', 'apart-elementor-video-player' ),
		...
		$this->add_control(
			'lightbox',
			[
				'label' => esc_html__( 'Lightbox', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_off' => esc_html__( 'Off', 'apart-elementor-video-player' ),
				'label_on' => esc_html__( 'On', 'apart-elementor-video-player' ),
				'condition' => [
					'show_image_overlay' => 'yes',
					'image_overlay[url]!' => '',
				],
		...
		$this->add_control(
			'aspect_ratio',
			[
				'label' => esc_html__( 'Aspect Ratio', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'169' => '16:9',
					'219' => '21:9',
				...
				'default' => '169',
				'selectors' => [
					'{{WRAPPER}} .apart-elementor-wrapper' => '--video-aspect-ratio: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'css_filters',
				'selector' => '{{WRAPPER}} .apart-elementor-wrapper',
			]
		);
		...
		$this->add_control(
			'play_icon_color',
			[
				'label' => esc_html__( 'Color', 'apart-elementor-video-player' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .apart-elementor-custom-embed-play i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .apart-elementor-custom-embed-play svg' => 'fill: {{VALUE}}',
				],
				'condition' => [
					'show_image_overlay' => 'yes',
					'show_play_icon' => 'yes',
		...
		$this->add_responsive_control(
			'play_icon_size',
			[
				'label' => esc_html__( 'Size', 'apart-elementor-video-player' ),
				...
				'selectors' => [
					'{{WRAPPER}} .apart-elementor-custom-embed-play i' => 'font-size: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .apart-elementor-custom-embed-play svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_image_overlay' => 'yes',
					'show_play_icon' => 'yes',
	...
	private function render_hosted_video() {
		...
		?>
		<video class="apart-elementor-video" src="<?php echo esc_attr( $video_url ); ?>" <?php Utils::print_html_attributes( $video_params ); ?>></video>
		<?php
	}
	...
	public function print_a11y_text( $image_overlay ) {
		if ( empty( $image_overlay['alt'] ) ) {
			echo esc_html__( 'Play Video', 'apart-elementor-video-player' );
		} else {
			echo esc_html__( 'Play Video about', 'apart-elementor-video-player' ) . ' ' . esc_attr( $image_overlay['alt'] );
		}
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'video-wrapper', 'class', 'apart-elementor-wrapper' );
		...
		<div <?php $this->print_render_attribute_string( 'video-wrapper' ); ?>>
			...
			if ( $this->has_image_overlay() ) {
				$this->add_render_attribute( 'image-overlay', 'class', 'apart-elementor-custom-embed-image-overlay' );
				...
				if ( $settings['lightbox'] ) {
					...
					$lightbox_options = [
						...
						'modalOptions' => [
							'id' => 'apart-elementor-lightbox-' . $this->get_id(),
				...
				<div <?php $this->print_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
						<div class="apart-elementor-custom-embed-play" role="button" aria-label="<?php $this->print_a11y_text( $settings['image_overlay'] ); ?>" tabindex="0">
							<?php
		...
		<style>
			...
			.apart-elementor-wrapper .apart-elementor-video,
			.apart-elementor-wrapper iframe {
				position: absolute;
				top: 0;
				left: 0;
				width: 100%;
			...
			.apart-elementor-custom-embed-image-overlay {
				position: absolute;
				top: 0;
				left: 0;
				width: 100%;
			...
			.apart-elementor-custom-embed-play {
				width: 68px;
				height: 68px;
				border-radius: 50%;
			...
			.apart-elementor-custom-embed-play:hover {
				background-color: rgba(0, 0, 0, 0.7);
				transform: scale(1.1);
			}
			.apart-elementor-custom-embed-play i,
			.apart-elementor-custom-embed-play svg {
				margin-left: 3px;
			}
		</style>
		<?php
